...
prefixes = "манда хуе шлюх хуи хой хюй хуй хую хуя пизд пезд блят блиат бляд сук сюк пидар пидор еб бзд пидр педр хул залуп спизд спизж пизж".split()
...
short = "бля бл нах сучка мозгоеб мозгоебина".split()

all_symb = list("абвгдеёжзийклмнопрстуфхцчшщыэюя")+list("abcdefghijklmnopqrstuvwxyz")+[" "]
for allow, _ in bpss:
